...
/** Health ARCA (`FEDummy`): mismo gate que emitir CAE (módulo facturación, simple o editor). */
export async function guardFacturacionLectura(): Promise<NextResponse | null> {
  const rol = await getRol();
