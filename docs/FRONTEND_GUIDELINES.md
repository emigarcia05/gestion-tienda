...
- **Tesorería:** 4 filtros en una fila. Pie dos filas de tarjetas (tipo de valor / disponibilidad). Cheques: tenencia ACTUALES / TRANSFERIDOS. TIPO CAJA en pantalla: `EFECTIVO` → **CAJA LOCAL**; `TARJETAS_A_COBRAR` → **TERMINAL DE PAGO** (`etiquetaTipoCajaEnPantalla`).
